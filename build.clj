...
(def ^:private pom-template
  [[:description "Recurring task scheduler for Clojure on the JVM, that just keeps on ticking."]
   [:url "https://github.com/lukaszkorecki/on-and-on"]
   [:licenses
    [:license
     [:name "MIT"]
   ...
   [:scm
    [:url "https://github.com/lukaszkorecki/on-and-on"]
    [:connection "scm:git:git://github.com/lukaszkorecki/on-and-on.git"]
    [:developerConnection "scm:git:ssh://git@github.com/lukaszkorecki/on-and-on.git"]]])
